...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR / "templates"],  # Indicamos donde busca django los templates.
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
AUTH_USER_MODEL = "accounts.CustomUser"  # Le decimos a django que utilize nuestro propio user model, llamado CustomUser, en vez del user model que viene por defecto.
